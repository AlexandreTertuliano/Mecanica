...
public class Tela_Agendamento extends JPanel {
	...
	private void initComponents() {
		...
		Label_Edita_serviço = new java.awt.Label("");
		Label_editavel_nome = new java.awt.Label("");
		Label_data_editavel = new javax.swing.JLabel("");
		Label_Dia_editavel = new javax.swing.JLabel("");
		...
		try {
			Field_Data.setFormatterFactory(
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(layout.createSequentialGroup().addContainerGap()
						.addGroup(layout
								.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
										.createSequentialGroup().addGroup(layout.createParallelGroup(
												javax.swing.GroupLayout.Alignment.TRAILING).addComponent(
														Label_Data_Semana)
												.addComponent(Label_titulo_Agendamento).addComponent(Label_Placa)
												.addGroup(layout
										...
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												...
												.addGroup(layout.createSequentialGroup().addGap(8, 8, 8).addGroup(layout
														.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
														.addComponent(Field_servico,
																javax.swing.GroupLayout.DEFAULT_SIZE,
																javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
														.addGroup(layout.createSequentialGroup().addGroup(layout
																.createParallelGroup(
																		javax.swing.GroupLayout.Alignment.LEADING)
																.addComponent(Radio_domingo).addComponent(Radio_sabado)
																.addComponent(Radio_sexta).addComponent(Radio_Segunda)
																.addComponent(Radio_terça).addComponent(Radio_quinta)
																.addComponent(
																		Radio_Quarta)
																.addGroup(layout.createSequentialGroup()
																		.addComponent(Btn_Cancelar).addGap(18, 18, 18)
																		.addComponent(Btn_Salvar).addGap(18, 18, 18)
																		.addComponent(Btn_excluir))
																.addGroup(layout.createSequentialGroup().addGroup(layout
																		.createParallelGroup(
																				javax.swing.GroupLayout.Alignment.LEADING,
																				false)
																		.addComponent(Field_Nome_Pessoa,
																				javax.swing.GroupLayout.DEFAULT_SIZE,
																				javax.swing.GroupLayout.DEFAULT_SIZE,
																				Short.MAX_VALUE)
																		.addComponent(
														...
														.addGroup(layout
																.createParallelGroup(
																		javax.swing.GroupLayout.Alignment.LEADING)
																.addComponent(Scroll_Agendamento,
								...
								.addGroup(layout.createSequentialGroup()
										.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(Label_Dia_editavel, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(Label_data_editavel, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(Label_editavel_nome, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addComponent(Label_Edita_serviço, javax.swing.GroupLayout.DEFAULT_SIZE,
														javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
												.addGroup(layout.createSequentialGroup().addComponent(Label_informacoes)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(layout
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false).addGroup(layout
						...
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								...
								.addComponent(Field_Placa_Veiculo, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(Label_Nome)
								.addComponent(Field_Nome_Pessoa, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(13, 13, 13)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(Label_Data)
								.addComponent(Field_Data, javax.swing.GroupLayout.PREFERRED_SIZE,
										javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(Btn_Gerar_dia))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(Label_Data_Semana).addComponent(Radio_Segunda))
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(Radio_terça)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Radio_Quarta)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Radio_quinta)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Radio_sexta)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Radio_sabado)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Radio_domingo)
						.addGap(9, 9, 9)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(Label_Servico).addComponent(Field_servico,
				...
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
								.addComponent(Btn_Cancelar).addComponent(Btn_Salvar).addComponent(Btn_excluir))
						.addGroup(layout.createSequentialGroup().addComponent(Label_Seleciona_Linha)
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
								.addComponent(Btn_informações)))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						...
						.addGroup(layout.createSequentialGroup().addGap(7, 7, 7).addComponent(jSeparator2,
								javax.swing.GroupLayout.PREFERRED_SIZE, 10, javax.swing.GroupLayout.PREFERRED_SIZE)))
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addComponent(Label_editavel_nome, javax.swing.GroupLayout.PREFERRED_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Label_data_editavel)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Label_Dia_editavel)
				.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
				.addComponent(Label_Edita_serviço, javax.swing.GroupLayout.PREFERRED_SIZE, 20,
						javax.swing.GroupLayout.PREFERRED_SIZE)
		...
		Btn_Gerar_dia.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (result.equals("Mon"))
					Radio_Segunda.setSelected(true);
				if (result.equals("Tue"))
					Radio_terça.setSelected(true);
				if (result.equals("Wed"))
					Radio_Quarta.setSelected(true);
				if (result.equals("Thu"))
					Radio_quinta.setSelected(true);
				if (result.equals("Fri"))
					Radio_sexta.setSelected(true);
				if (result.equals("Sad"))
					Radio_sabado.setSelected(true);
				if (result.equals("Sun"))
					Radio_domingo.setSelected(true);
		...
		Btn_excluir.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				Verificar_linha_agendamento_delete();
				Update_Agendamento();
				update_tabela();
				Limpa_dados();
		...
		Btn_informações.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Verificar_linha_agendamento_informacoes();
		...
		Btn_Cancelar.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				int resposta = JOptionPane.showConfirmDialog(null, "Deseja realmente cancelar o agendamento",
						"Cadastro de Agendamentos", JOptionPane.YES_NO_OPTION);
	...
	private boolean Verifica_update() {
		...
		if (Field_Placa_Veiculo.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Por favor, preencha a PLACA DO VEICULO", "Campo vazio",
					JOptionPane.WARNING_MESSAGE);
			Field_Placa_Veiculo.requestFocus();
			return false;
		}
		if (Field_Nome_Pessoa.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Por favor, preencha o NOME", "Campo vazio",
					JOptionPane.WARNING_MESSAGE);
			Field_Nome_Pessoa.requestFocus();
			return false;
		}
		if (Field_Data.getText().trim().isEmpty() || Field_Data.getText().equals("  /  /    ")) {
			JOptionPane.showMessageDialog(this, "Por favor, preencha a DATA", "Campo vazio",
					JOptionPane.WARNING_MESSAGE);
		...
		if (Field_servico.getText().trim().isEmpty()) {
			JOptionPane.showMessageDialog(this, "Por favor, preencha o SERVICO", "Campo vazio",
					JOptionPane.WARNING_MESSAGE);
	...
	private void Update_Agendamento() {
		...
		LocalDate dia = LocalDate.of(Integer.parseInt(DataSeparada[2]), Integer.parseInt(DataSeparada[1]),
	...
	private void Cad_Agendamento() {
		...
		JOptionPane.showMessageDialog(this,
				agendamento.getNome() + " foi cadastrado" + " com sucesso! \n Verifique na tabela ao lado !",
				"Cadastro concluido", JOptionPane.INFORMATION_MESSAGE);
		update_tabela();
	...
	public void update_tabela() {
		...
		for (Agendamento_add agendamento : agendamentoDAO.getAll()) {
			Object[] data = { agendamento.getPlaca(), agendamento.getNome(), agendamento.getData_Agenda(),
	...
	public void data() {
	  ...
	  private void Verificar_linha_agendamento_delete(){
	  ...
	  private void Verificar_linha_agendamento_informacoes(){
		  
			 int Numero_linha = Table_Agendamento.getSelectedRow();
			 if(Numero_linha == -1) {
				  JOptionPane.showMessageDialog(this, "Informaçôes não encontrada", "Erro", JOptionPane.WARNING_MESSAGE);
			 }else if(Numero_linha >=0){
				 Sql_SetarDados();
	  ...
	  private void Sql_SetarDados(){
		  int Numero_linha = Table_Agendamento.getSelectedRow();
		  String Placa = (String)Table_Agendamento.getModel().getValueAt(Numero_linha, 0);
		  String Nome = (String) Table_Agendamento.getModel().getValueAt(Numero_linha, 1);
		  Date Data_Agenda = (Date) Table_Agendamento.getModel().getValueAt(Numero_linha, 2);
		  String Servico = (String) Table_Agendamento.getModel().getValueAt(Numero_linha, 3);
		  
		  String sql = "select from agendamentos where placa = '" +
		  Placa + "' and data_agenda = '" +
				  Data_Agenda + "' and nome = '" +
		  Nome + "' and servico = '" + Servico + "'";
		  
		  
		  	Field_Placa_Veiculo.setText(Placa);
			Field_Nome_Pessoa.setText(Nome);
			Field_Data.setText(Data_Agenda.toString());
			Field_servico.setText(Servico);
			
			Field_Placa_Veiculo.setText(Placa);
			Label_editavel_nome.setText(Nome);
			Label_data_editavel.setText(Data_Agenda.toString());
			Label_Edita_serviço.setText(Servico);
	...
	private void Sql_Delete(){
		  ...
		  String sql = "delete from agendamentos where placa = '" +
		  Placa + "' and data_agenda = '" +
				  Data_Agenda + "' and nome = '" +
		  Nome + "' and servico = '" + Servico + "'";
		  ...
		  try {
			 ...
			 JOptionPane.showMessageDialog(this, "Agendamento de " + Nome +" Cancelado", "Excluído", JOptionPane.WARNING_MESSAGE);
