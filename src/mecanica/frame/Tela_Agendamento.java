...
public class Tela_Agendamento extends JPanel {
	...
	public void Mostrar_CadastroEnd() {
		for (Agendamento_add agendamento : agendamentoDAO.getAll()) {

			Field_Placa_Veiculo.setText(agendamento.getPlaca());
			Label_editavel_nome.setText(agendamento.getNome());
			//Label_data_editavel.setText(agendamento.getData_Agenda());
			Label_Dia_editavel.setText(agendamento.getDia_Semana());
			Label_Edita_serviço.setText(agendamento.getServico());
