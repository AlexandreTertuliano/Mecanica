...
public class Tela_Cliente_receber_valor_marcado extends JPanel {
	 ...
	 public Tela_Cliente_receber_valor_marcado()  {
	        initComponents();
	    }
	 ...
	 private void initComponents() {
	        ...
	        Btn_Cancelar_Venda = new javax.swing.JButton();
	        Label_Ed_Total = new javax.swing.JLabel();
	        Label_Total = new javax.swing.JLabel();
	        Label_Titulo_Venda = new javax.swing.JLabel();
	        jSeparator2 = new javax.swing.JSeparator();
	        Btn_Bloquear = new javax.swing.JButton();
	        LabePago = new javax.swing.JLabel();
	        Field_Valor_Pago = new javax.swing.JFormattedTextField();
	        Btn_Receber = new javax.swing.JButton();
	        jScrollPane2 = new javax.swing.JScrollPane();
	        jTable2 = new javax.swing.JTable();
	        Label_Movimentacao = new javax.swing.JLabel();
	        Btn_Movimento_1Mes = new javax.swing.JButton();
	        ...
	        Label_Placa.setText("Digite a placa do Carro");	      

	        Btn_Cancelar_Venda.setText("jButton1");

	        Label_Ed_Total.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
	        Label_Ed_Total.setText("0.00");

	        Label_Total.setFont(new java.awt.Font("Arial Black", 0, 18)); // NOI18N
	        Label_Total.setText("jLabel1");

	        Label_Titulo_Venda.setFont(new java.awt.Font("Arial Black", 0, 14)); // NOI18N
	        Label_Titulo_Venda.setText("Controle");

	        Btn_Bloquear.setText("jButton1");

	        LabePago.setText("Valor Pago");

	        Btn_Receber.setText("jButton1");
	        ...
	        Label_Movimentacao.setText("Cliente sem movimentação durante 1 mês");

	        Btn_Movimento_1Mes.setText("jButton1");
